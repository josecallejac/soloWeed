...
### R1. E2E Test Suite Creation
Write an End-to-End (E2E) test suite covering the core user flows of the soloWeed application (e.g., product browsing, search, detail view).

### R2. Test Suite Only
The agents must only write the test code and configuration files. Do not modify existing application code or attempt to fix application bugs discovered by the tests.
