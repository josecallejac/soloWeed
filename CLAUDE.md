...
SoloWeed: a price comparator (inspired by SoloTodo) for cannabis paraphernalia in Chile — bongs, pipes, grinders, rolling papers, vaporizers, etc. It does not sell anything; it scrapes six stores (Astro Growshop, Fumetas, Piranha, GrowBarato Chile, Kushbreak, Friendly Grow) and links to them. Stack: Next.js 16 App Router + TypeScript + Tailwind 4, Prisma + SQLite, Cheerio for scraping.
