  ...
  async headers() {
    ...
    if (process.env.NODE_ENV === "production") {
      ...
      securityHeaders.push({
        ...
        value: "default-src 'self'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; img-src 'self' https: data: blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline'; connect-src 'self' https:; font-src 'self' data:",
      });
    }
